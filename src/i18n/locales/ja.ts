...
export const ja: Translations = {
  ...
  settings: {
    ...
    navAbout: "このアプリについて",
    descProfile: "Googleでサインイン中。プロフィール情報はGoogleアカウントから取得しています。",
    descSession: "このデバイスでの現在のセッションを終了します。",
    descLocale: "アプリ全体のUI文言に反映されます。",
    descClickTrack: "オートモード中、各拍でクリック音を鳴らします。",
    descCountIn: "オートモードで、曲開始前に4拍カウントインします。",
    descClickVolume: "メトロノーム音声の出力レベル。",
    descClickSoundChar: "メトロノームの音色。",
    descAccentDownbeat: "各小節の1拍目を強調します。",
    descPreRoll: "カウントイン前の無音小節数(オート)。",
    descTheme: "ダーク、システム連動、ライトを切り替えます。",
    descKeyboard: "パフォーマンスモードで使えるキーボードショートカット。",
    descBuild: "現在のデプロイのバージョン情報。",
    ariaClickTrack: "クリックトラック",
    ariaCountIn: "カウントイン",
    ariaClickVolume: "クリック音量",
    ariaAccentDownbeat: "ダウンビートアクセント",
    soundDescTick: "鋭い、木系",
    soundDescBeep: "サイン波",
    soundDescSnap: "アナログクリック",
    soundDescRim: "ドラムのリム",
    shortcutAdvance: "1小節進む (Perform)",
    shortcutPrevious: "1小節戻る (Perform)",
    shortcutReset: "セクション01へリセット (Perform)",
    shortcutExit: "Performを終了",
  },
  perform: {
    section: "セクション",
    of: "/",
