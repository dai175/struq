...
export const ja: Translations = {
  ...
  settings: {
    ...
    desc: {
      profile: "Googleアカウントから取得したプロフィール情報です",
      session: "現在のセッションを終了します",
      locale: "アプリ全体に反映されます",
      clickTrack: "各拍でクリック音を鳴らします（Auto）",
      countIn: "曲開始前に4拍カウントインします（Auto）",
      clickVolume: "クリック音の出力レベル",
      clickSoundChar: "クリック音の音色",
      accentDownbeat: "各小節の1拍目を強調します",
      preRoll: "カウントイン前の無音小節数（Auto）",
      theme: "テーマを切り替えます",
      keyboard: "Performモードで使えるキーボードショートカット",
      build: "現在のバージョン情報",
    },
    aria: {
      clickTrack: "クリックトラック",
  ...
  auth: {
    ...
    heroMobileDim: "手元に。",
    bodyCopy:
      "練習と本番のためのミュージシャン向けコンソール。セクションをマップし、クリックを鳴らし、セットリストを常に手元に — iPhoneからiPadモニターまで。",
    signInTitle: "サインイン",
